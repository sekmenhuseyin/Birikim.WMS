...
namespace Wms12m.Presentation
{
    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //css libraries
            bundles.Add(new StyleBundle(bootstrapCss, "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css") { CdnFallbackExpression = "$.fn.modal" }.Include("~/Content/assets/global/plugins/bootstrap/css/bootstrap.min.css"));
            bundles.Add(new StyleBundle(jqueryUiCss, "https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.css") { CdnFallbackExpression = "window.jQuery.ui" }.Include("~/Content/assets/global/plugins/jquery-ui/jquery-ui.css"));
            bundles.Add(new StyleBundle(toastrCss, "https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.3/toastr.min.css") { CdnFallbackExpression = "window.jQuery.ui" }.Include("~/Content/assets/global/plugins/toastr/toastr.css"));
            bundles.Add(new StyleBundle(FontAwesome, "https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css") { CdnFallbackExpression = "$.fn.modal" }.Include("~/Content/assets/global/plugins/font-awesome/css/font-awesome.min.css"));
            bundles.Add(new StyleBundle(simpleLineIcons, "https://cdnjs.cloudflare.com/ajax/libs/simple-line-icons/2.4.1/css/simple-line-icons.css") { CdnFallbackExpression = "window.jQuery.ui" }.Include("~/Content/assets/global/plugins/simple-line-icons/css/simple-line-icons.min.css"));
            //vars
