...
{
    public class Guarantee2Controller : RootController
    {
        ...
        public ActionResult Tanim()
        {
            ...
            var CHK = db.Database.SqlQuery<RaporCHKSelect>(string.Format("[FINSAT6{0}].[wms].[CHKSelect2]", vUser.SirketKodu)).ToList();
            return View(CHK);
        }
