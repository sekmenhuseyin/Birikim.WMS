...
namespace Wms12m.Presentation.Controllers
{
    public class SalesController : RootController
    {
        ...
        public ActionResult Step2(frmSiparisOnay tbl)
        {
            ...
            foreach (var item in sirketler)
            {
                ...
                sql += String.Format("SELECT '{0}' as SirketID, FINSAT6{0}.FINSAT6{0}.SPI.MalKodu, (FINSAT6{0}.FINSAT6{0}.SPI.BirimMiktar - FINSAT6{0}.FINSAT6{0}.SPI.TeslimMiktar - FINSAT6{0}.FINSAT6{0}.SPI.KapatilanMiktar) AS Miktar, FINSAT6{0}.FINSAT6{0}.SPI.Birim, wms.fnGetStock('{1}',FINSAT6{0}.FINSAT6{0}.SPI.MalKodu,FINSAT6{0}.FINSAT6{0}.SPI.Birim) AS Stok " +
                                    ...
                                    "ISNULL(wms.fnGetStock('{1}',FINSAT6{0}.FINSAT6{0}.SPI.MalKodu,FINSAT6{0}.FINSAT6{0}.SPI.Birim),0)>0", item, tbl.DepoID, evraklar[i]);
                i++;
            }
        ...
        public PartialViewResult GetSiparis(string DepoID, string Starts, string Ends)
        {
            ...
            List<frmSiparisler> list = new List<frmSiparisler>();
            try
            {
                foreach (var item in tmp)
                {
                    string sql = String.Format("FINSAT6{0}.wms.getSiparisList @SirketKodu = '{0}', @DepoKodu = '{1}', @isKable = 0, @BasTarih = {2}, @BitTarih = {3}", item, DepoID, StartDate.ToOADateInt(), EndDate.ToOADateInt());
                    var l2 = db.Database.SqlQuery<frmSiparisler>(sql).ToList();
                    list.AddRange(l2);
                }
                //return list
                ViewBag.Depo = DepoID;
