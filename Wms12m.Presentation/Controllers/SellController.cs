        ...
        public ActionResult Approve(frmSiparisOnay tbl)
        {
            ...
            foreach (var item in sirketler)
            {
                ...
                sql += String.Format("SELECT '{0}' as SirketID, FINSAT6{0}.FINSAT6{0}.SPI.EvrakNo, FINSAT6{0}.FINSAT6{0}.SPI.Chk, FINSAT6{0}.FINSAT6{0}.SPI.MalKodu, FINSAT6{0}.FINSAT6{0}.SPI.Birim, FINSAT6{0}.FINSAT6{0}.CHK.Unvan1 as Unvan, (FINSAT6{0}.FINSAT6{0}.SPI.BirimMiktar - FINSAT6{0}.FINSAT6{0}.SPI.TeslimMiktar - FINSAT6{0}.FINSAT6{0}.SPI.KapatilanMiktar) AS Miktar, FINSAT633.FINSAT633.SPI.TeslimChk, FINSAT633.FINSAT633.SPI.ValorGun, FINSAT633.FINSAT633.MFK.Aciklama " +
                                    ...
                                    "FROM FINSAT6{0}.FINSAT6{0}.SPI WITH(NOLOCK) INNER JOIN FINSAT6{0}.FINSAT6{0}.CHK WITH(NOLOCK) ON FINSAT6{0}.FINSAT6{0}.SPI.Chk = FINSAT6{0}.FINSAT6{0}.CHK.HesapKodu INNER JOIN FINSAT633.FINSAT633.MFK WITH (NOLOCK) ON FINSAT633.FINSAT633.SPI.KynkEvrakTip = FINSAT633.FINSAT633.MFK.KynkEvrakTip AND FINSAT633.FINSAT633.SPI.Chk = FINSAT633.FINSAT633.MFK.HesapKod AND  FINSAT633.FINSAT633.SPI.Tarih = FINSAT633.FINSAT633.MFK.EvrakTarih AND FINSAT633.FINSAT633.SPI.EvrakNo = FINSAT633.FINSAT633.MFK.EvrakNo " +
                                    ...
                                    "GROUP BY FINSAT633.FINSAT633.SPI.EvrakNo, FINSAT633.FINSAT633.SPI.Chk, FINSAT633.FINSAT633.SPI.MalKodu, FINSAT633.FINSAT633.SPI.Birim, FINSAT633.FINSAT633.CHK.Unvan1, FINSAT633.FINSAT633.SPI.BirimMiktar - FINSAT633.FINSAT633.SPI.TeslimMiktar - FINSAT633.FINSAT633.SPI.KapatilanMiktar, FINSAT633.FINSAT633.SPI.TeslimChk, FINSAT633.FINSAT633.SPI.ValorGun, FINSAT633.FINSAT633.MFK.Aciklama", item, tbl.DepoID, evraklar[i], ids[i]);
                i++;
            }
