...
namespace Wms12m.Business
{
    public class Corridor : abstractTables<Koridor>
    {
        ...
        public override Result Operation(Koridor tbl)
        {
            ...
            {
                helper.Logger(Users.AppIdentity.User.UserName, ex, "Business/Corridor/Operation");
                _Result.Id = 0;
        ...
        public override Result Delete(int Id)
        {
            ...
            {
                helper.Logger(Users.AppIdentity.User.UserName, ex, "Business/Corridor/Delete");
        ...
        public override Koridor Detail(int Id)
        {
            ...
            {
                helper.Logger(Users.AppIdentity.User.UserName, ex, "Business/Corridor/Detail");
                return new Koridor();
            }
        }
        /// <summary>
